...
void bp::PlanetSpawner::initialize(dbasic::DeltaEngine* engine, Universe* universe)
{
...
void bp::PlanetSpawner::planetCreation()
{
	...
	newObject1->getPhysicsComponent()->m_transform.SetPosition(ysMath::LoadVector(ysMath::UniformRandom(100.0), ysMath::UniformRandom(100.0), ysMath::UniformRandom(100.0)));
